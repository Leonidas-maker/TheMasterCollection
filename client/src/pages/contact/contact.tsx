...
function Contact() {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 min-h-screen flex flex-col">
            <NavbarSubpages />
            <div className="flex-grow py-8 lg:py-16 px-4 mx-auto w-2/3 lg:w-auto">
                <h2 className="my-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-gray-300">{t('contact.contact')}</h2>
