    ...
    return (
        <div className="bg-white dark:bg-gray-900 min-h-screen flex flex-col">
            ...
            <div className="flex-grow flex flex-col justify-center items-center">
                <h1 className="text-6xl font-bold mb-14 dark:text-gray-300 text-black">{t('credits.credits')}</h1>
                <div className="rounded-3xl shadow-lg p-6 bg-gray-300 dark:bg-gray-800 text-center text-black dark:text-gray-300 text-xl font-bold w-1/3 mx-auto">
